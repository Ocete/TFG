...
% Format based on:
% https://grados.ugr.es/informaticaymatematicas/pages/infoacademica/tfg/formato/formato_memoriatfgdg

\input{add_ons/summary}
\input{add_ons/resumen_extendido}

\input{add_ons/introduction}

% Development
\input{chapters/chapter1_QuantumMechanicsModel}
\input{chapters/chapter2_QuantumAnnealing}
\input{chapters/chapter3_GenomeAssembly}
...
% Part II
%\input{chapters/chapter5_GenomeAssembly}
