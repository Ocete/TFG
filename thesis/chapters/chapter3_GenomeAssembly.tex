...
\begin{table}[H]
	...
	\caption{Results of experiment 5 using the simulated annealer.}
	\label{tab:exp5_1}
\end{table}
...
\begin{table}[H]
	...
	\caption{Results of experiment 5 using the quantum annealer.}
	\label{tab:exp5_2}
\end{table}
